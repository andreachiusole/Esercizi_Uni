...
// !!!! può essere usato una sola volta come dichiarazione di una struttura
// in questo caso viene allocata memoria
struct {
    double a;
    double b;
} unica;

//scrivere il nome di una variabile
...
int main(){
    topo.eta = 4; 
    //metodo per accedere al campo età della struct topo. Usare il '.' dopo il nome della struct
    ...
    */
    ...
    // Inizializzo il primo elemento del vettore di persone in classe
    classe[0].eta = 5;
    ...
    // Devo utilizzare l'operatore '->'. Questo puntatore implica la deferenziazione del puntatore
